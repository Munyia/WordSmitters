        ...
        <footer className="sm:gap-6 relative flex sm:p-16 flex-col bg-white sm:bg-pry sm:text-white w-full flex-wrap mt-[30%]">
          <div className=" bg-sec f-shadow rounded-2xl items-center flex flex-col gap-4 text-white mx-auto py-[100px] px-9 text-left w-[96%]  sm:hidden">
            ...
            <div className="h-[38px] flex rounded border border-black">
              <div className="flex px-2 justify-center items-center">
                <input type="text" placeholder="YOUR EMAIL" className="text-[12px]" />
              </div>
          ...
          <div className="flex f-shadow2 pt-11 mt-24 sm:mt-0 sm:pt-0 justify-between sm:my-4 flex-col sm:flex-row items-center sm:items-start">
            <div className="flex gap-8 sm:gap-4 md:gap-10 w-[70%] flex-col sm:flex-row">
              <div className="flex w-full flex-col items-center gap-4 sm:text-[10px] md:text-[16px] font-[400] sm:w-[25%] md:w-[20%]">
                ...
                <p className="hidden sm:block md:text-[0.75rem] sm:text-[0.5rem]">contact@topmeangel.com</p>
              </div>
          ...
          <div className="flex flex-col sm:items-center sm:flex-row sm:gap-4 text-[#808080] sm:text-white text-[10px]  font-[400] flexWrap">
            ...
            <div className="items-center text-[#808080] text-[16px]  flex justify-center gap-6 w-full mt-5 mb-3 sm:hidden">
                ...
                <p className=" font-normal text-[0.75rem] text-center text-[#808080] mb-6 sm:hidden">contact@topmeangel.com</p>
          </div>
    
          {isModalOpen && (<div className={`fixed  flex justify-center items-center left-0 z-50 bottom-0 w-[100vw] h-[100vh] bg-[rgba(0,0,0,0.1)]`}>
                ...
                <div className={`bg-white   text-black inline-flex px-3 text-[10px] rounded-xl py-2 gap-3 flex-col`}>
                  <p className=" font-semibold self-center text-[12px]">SUBSCRIBE TO OUR NEWSLETTER</p>
                  <p>Please insert your Email address</p>
                  <form action="" className="flex flex-col gap-3">
                  <div className="w-full border-black border rounded-lg py-3 px-2">
                  <input type="text" placeholder="INPUT EMAIL" className="outline-none text-[8px]" />
                  </div>
                  <div className="flex text-[9px] gap-2 items-center pl-10"> 
                    <div className="relative bg-slate-600 rounded-full w-6 h-6"><div className="absolute -left-1/2 bg-red-600 rounded-full w-6 h-6"> <div className="absolute -left-1/2 bg-yellow-600 rounded-full w-6 h-6"><div className="absolute -left-1/2 bg-green-600 rounded-full w-6 h-6"> </div> </div> </div> </div>
                    <span className=" font-semibold -mr-[6px]">+2,030</span><span>Subscribers</span>
                  </div>
                  <div className="flex text-[10px] gap-3 justify-between">
                  <button type="submit" className=" bg-black text-white rounded px-9 ">SUBSCRIBE</button>
                  <button onClick={closeModal} className=" border rounded px-9 py-2 border-black">CANCEL</button>
                  </div>
                  </form>
                </div>
                </div>

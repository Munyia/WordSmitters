  ...
  return (
    <div className='text-white  bg-[#CD9564] relative gap-5 pr flex w-full h-[13vh] bg- justify-between items-center' id='Navbar'>
       ...
       <Link to={'/'}><img src={llogo} className='h-[16vh]' alt="" /></Link>
          <Link to={"/about"} className='flex hover:underline text-lg hover:text-xl'>About</Link>
          <Link to={"/books"}  className='flex hover:underline text-lg hover:text-xl'>Books</Link>
       </div>

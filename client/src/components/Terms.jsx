...
const Terms = () => {
  ...
  return (
   ...
   <p className='w-full text-center underline mb-10'> Terms and Condition</p>
  </div>
        <div className=' flex relative  flex-col'>
            <div className='flex text-2xl rounded-3xl px-5 py-5 bg-white/30 backdrop-blur-lg text-black border border-transparent shadow-xl justify-center  text-center  mb-4 pl-10 pr-10 '> Welcome to <span className='text-pry '> WordSmitters</span> </div>
            <p className=' text-xl justify-center rounded-3xl px-5 py-5 bg-white/30 backdrop-blur-lg text-black border border-transparent shadow-xl align-middle text-center  mb-4 pl-10 pr-10  '>These terms and conditions outline the rules and regulations for the use of our book web app. 
...
<div className='flex flex-col  gap-5 text-lg justify-items-start  '>
  ...
  <p className='rounded-3xl px-5 py-5 bg-white/30 backdrop-blur-lg text-black border border-transparent shadow-xl'>By using <span className='text-pry '> WordSmitters</span>, you signify your acceptance of these terms and conditions. If you have any questions or concerns about these terms, please contact us at <span> contact@<span className='text-pry '> WordSmitters</span>.com.</span></p>
</div>

...
const About = () => {
  ...
  return (
    <div  className='flex font-medium text-lg leading-loose tracking-wide gap-5  py-5 flex-col px-[12.5%] bg-gradient-to-br from-[rgb(11,31,10)] via-[rgb(7,49,3)] to-[rgb(6,49,6)]  text-white align-middle   '>
    <div className='flex pt-2  text-3xl align-middle justify-between text-center'>
  
  <p className='w-full underline text-center mb-5 '> About<span className='text-pry '> WordSmitters</span></p>
  
 </div>
 <div className='flex justify-center rounded-3xl px-2 bg-white/30 backdrop-blur-lg text-black pb-4 align-middle text-center border border-transparent shadow-xl'> 
    <p>Welcome to <span className='text-pry'>WordSmitters</span>, your premier destination for exploring the vibrant world of Nigerian literature. Founded with a passion for promoting Nigerian authors and showcasing the rich tapestry of Nigerian culture through literature, <span className='text-pry'>WordSmitters</span> aims to be the bridge that connects readers with captivating stories, insightful narratives, and diverse voices from Nigeria.</p>
      ...
      <div className='text-lg rounded-3xl px-5 py-5 bg-white/30 backdrop-blur-lg text-black border border-transparent shadow-xl '>

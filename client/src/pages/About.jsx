...
const About = () => {
  return (
    <div>
      <div>
        <p>About Wordsmitters</p>
        <p>Welcome to Wordsmitters, your premier destination for exploring the vibrant world of Nigerian literature. Founded with a passion for promoting Nigerian authors and showcasing the rich tapestry of Nigerian culture through literature, Wordsmitters aims to be the bridge that connects readers with captivating stories, insightful narratives, and diverse voices from Nigeria.</p>
      </div>
      <div>
        <p>Our Mission</p>
